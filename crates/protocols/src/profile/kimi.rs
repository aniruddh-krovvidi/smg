...
//! models keep OpenAI's ranges. Only requests entering through `ValidatedJson`
//! reach these rules; the Responses conversion builds its chat request without
//! them.

use crate::{
    chat::{ChatCompletionRequest, ChatMessage, ThinkingType},
